...
export default function Settings({ navigate, goBank }) {
    const { curentUser, darkMode, toggleDarkMode, logout } = useUser();
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-900">
            <div className="sticky top-0 z-30  bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700 px-4 py-3 flex items-center gap-3">
                <button onClick={goBack || (() => navigate('profile/' + curentUser.username))} className="text-gray-600
                 dark:text-gray-400">⨉</button>
